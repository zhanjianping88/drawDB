...
export const metadata = createMetadata({
  title: "Terms of Service | SchemaForge",
  description:
    "Read the SchemaForge terms of service for use of the website and future database tooling platform.",
  path: "/terms",
});
    ...
    <div className="container-shell py-16 md:py-20">
      <div className="max-w-3xl space-y-6">
        ...
        <p className="text-base leading-7 text-muted-foreground">
          By using SchemaForge, you agree to use the site responsibly and not interfere with service
