...
export const metadata: Metadata = createMetadata({
  title: "SchemaForge Editor | Visual Database Design Workspace",
  description:
    "Open the SchemaForge editor powered by drawDB to create ER diagrams, load schema templates, and export SQL for PostgreSQL, MySQL, and SQLite workflows.",
  path: "/app",
});
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm leading-7 text-muted-foreground md:text-base">
                ...
                it inside the real editor powered by drawDB.
              </p>
            </div>
          </div>
